...
class MetadataUploaderTestCase(unittest.TestCase):
    ...
    @mock.patch('SuperPhy.models.upload.metadata_upload.open')
...
class GenomeMetadataUploaderTestCase(unittest.TestCase):
    ...
    @mock.patch('SuperPhy.models.upload.metadata_upload.ijson.parse')
    @mock.patch('SuperPhy.models.upload.metadata_upload.GenomeMetadataUploader.parse_metadata')
    ...
    @mock.patch('SuperPhy.models.upload.metadata_upload.GenomeMetadataUploader.add_to_graph')
    ...
    @mock.patch('SuperPhy.models.upload.metadata_upload.GenomeMetadataUploader.error_logging')
    @mock.patch('SuperPhy.models.upload.metadata_upload.GenomeMetadataUploader.create_pending_genome')
    ...
    @mock.patch('SuperPhy.models.upload.metadata_upload.BlazegraphUploader.upload_data')
    @mock.patch('SuperPhy.models.upload.metadata_upload.GenomeMetadataUploader.get_ncbi_ids')
    @mock.patch('SuperPhy.models.upload.metadata_upload.check_named_individual')
    ...
    @mock.patch('SuperPhy.models.upload.metadata_upload.return_elink_uid')
    @mock.patch('SuperPhy.models.upload.metadata_upload.return_esearch_uid')
...
class GeneMetadataUploaderTestCase(unittest.TestCase):
    ...
    @mock.patch('SuperPhy.models.upload.metadata_upload.GeneMetadataUploader.parse_amr')
    @mock.patch('SuperPhy.models.upload.metadata_upload.GeneMetadataUploader.parse_vf')
    ...
    @mock.patch('SuperPhy.models.upload.metadata_upload.GeneMetadataUploader.add_to_graph')
    @mock.patch('SuperPhy.models.upload.metadata_upload.GeneMetadata')
    ...
    @mock.patch('SuperPhy.models.upload.metadata_upload.GeneMetadataUploader.error_logging')
    @mock.patch('SuperPhy.models.upload.metadata_upload.GeneMetadataUploader.create_gene')
    def test_add_to_graph(self, mock_create, mock_error):
        mock_create.side_effect = TypeError
        self.case.add_to_graph(self.metadata)
        self.case.add_to_graph(self.metadata)
