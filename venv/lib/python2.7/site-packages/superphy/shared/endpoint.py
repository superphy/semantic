...
def query(data, url = os.getenv('SUPERPHY_RDF_URL')):
...
def ask(data, url = os.getenv('SUPERPHY_RDF_URL')):
	results = query(data)
...
def update(data, url = os.getenv('SUPERPHY_RDF_URL')):
	payload = {'update': data}
	r = requests.post(url, payload)
	return r.content

#Example data_location: "file:////home/ubiquitin/Documents/Ontologies/RDF Schemas for the Project/owl.ttl"
def file_update(data_location, url = os.getenv('SUPERPHY_RDF_URL')):
