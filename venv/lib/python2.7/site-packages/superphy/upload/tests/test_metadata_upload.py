...
from superphy.upload.metadata_upload import MetadataUploader, GenomeMetadata
...
class MetadataUploaderTestCase(unittest.TestCase):
    ...
    @mock.patch('superphy.upload.metadata_upload.MetadataUploader.parse_metadata')
    def test_upload(self, mock_parse, mock_ijson):
        self.case.upload()
        mock_ijson.assert_called_with(mock.ANY)
        mock_parse.assert_called_with(mock.ANY)

    @mock.patch('superphy.upload.metadata_upload.MetadataUploader.add_to_graph')
    ...
    @mock.patch('superphy.upload.metadata_upload.MetadataUploader.error_logging')
    @mock.patch('superphy.upload.metadata_upload.MetadataUploader.create_pending_genome')
    ...
    @mock.patch('superphy.upload.metadata_upload.MetadataUploader.get_ncbi_ids')
